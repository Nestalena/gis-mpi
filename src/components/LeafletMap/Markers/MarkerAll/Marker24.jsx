...
const Marker24 = (props) => {
    return (
        <Marker position={[63.22236, 123.27527]}>
            <Popup>
                <div>
                    <table className={classes.tableWells}>
                        ...
                        <tr>
                            ...
                            <td>Сосновый лес мертвопокровный</td>
                        </tr>
                        <tr>
                            <td><b>Напочвенный покров (мощность см)</b></td>
                            <td>Сосновый опад (1 см)</td>
                        </tr>
                        <tr>
                    ...
                    <div>
                        <a href="well24.txt" download="well24.txt">
