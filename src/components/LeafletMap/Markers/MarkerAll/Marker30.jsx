...
const Marker30 = (props) => {
    return (
        <Marker position={[63.07015, 138.08464]}>
            <Popup>
                <div>
                    <table className={classes.tableWells}>
                        ...
                        <tr>
                            ...
                            <td>Мощный ягельно-моховый покров до 20 см</td>
                        </tr>
                        <tr>
                    ...
                    <div>
                        <a href="well30.txt" download="well30.txt">
